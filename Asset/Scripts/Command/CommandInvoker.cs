...
public class CommandInvoker
{
    ...
    public static void ExecuteCommand(ICommandUndoable command)
    {
        ...
        if (command is not ISingleCommandUndoable || s_CommandObjectDict[ObjectIdString][command.IdName].s_UndoStack.FirstOrDefault(x => x.CmdName == command.CmdName) == null)
        {
